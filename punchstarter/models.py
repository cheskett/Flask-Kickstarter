...
class Project(db.Model):
	...
	short_description = db.Column(db.Text(100))
	long_description = db.Column(db.Text(100))
	goal_amount = db.Column(db.Integer)
	time_start = db.Column(db.DateTime)
	time_end = db.Column(db.DateTime)
	time_created = db.Column(db.DateTime)
	pledger = db.relationship('Pledge', backref="project", foreign_keys="Pledge.project_id")
